...
class File
{
    ...
    public const WITHOUT_EXTENSION = false;
    public const WITH_EXTENSION = true;

    public const WINDOWS = Dir::WINDOWS;
    public const UNIX = Dir::UNIX;
    ...
    public function delete()
    {
        if (!$this->isWriteable()) {
            return false;
        } // performace: does check exist, too
